...
test("validate", function (assert) {
  assert.deepEqual(
    validator.validate("stars", "100.000", attribute, {}),
    undefined
  );
  ...
  assert.deepEqual(
    validator.validate("stars", "12345", attribute, {}),
    undefined
  );
  assert.deepEqual(
    validator.validate("stars", "78.98", attribute, {}),
    undefined
  );
  ...
  assert.deepEqual(
    validator.validate("stars", "78.98,00", attribute, {}),
    "Stars must be a number"
  );
  assert.deepEqual(
    validator.validate("stars", false, attribute, {}),
    "Stars must be a number"
  );
  assert.deepEqual(
    validator.validate("stars", "some value", attribute, {}),
    "Stars must be a number"
  );
});
